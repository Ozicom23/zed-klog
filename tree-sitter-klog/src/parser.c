...
enum ts_symbol_identifiers {
  ...
  anon_sym_DASH = 6,
  anon_sym_LT = 7,
  aux_sym_time_token1 = 8,
  aux_sym_time_token2 = 9,
  anon_sym_GT = 10,
  sym_placeholder = 11,
  anon_sym_POUND = 12,
  sym__text = 13,
  ...
  sym__line_break = 17,
  sym__entry_break = 18,
  sym__continuation_break = 19,
  sym__record_separator = 20,
  sym__error_sentinel = 21,
  sym_source_file = 22,
  sym_record = 23,
  sym_should_total = 24,
  sym_record_summary = 25,
  sym_entry = 26,
  sym_entry_summary = 27,
  sym_range = 28,
  sym_open_range = 29,
  sym_time = 30,
  aux_sym__summary_line = 31,
  sym_tag = 32,
  aux_sym_source_file_repeat1 = 33,
  aux_sym_record_repeat1 = 34,
  aux_sym_record_summary_repeat1 = 35,
  aux_sym_entry_summary_repeat1 = 36,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [sym__entry_break] = "_entry_break",
  [sym__continuation_break] = "_continuation_break",
  [sym__record_separator] = "_record_separator",
  [sym__error_sentinel] = "_error_sentinel",
  [sym_source_file] = "source_file",
  [sym_record] = "record",
  [sym_should_total] = "should_total",
  [sym_record_summary] = "record_summary",
  [sym_entry] = "entry",
  [sym_entry_summary] = "entry_summary",
  [sym_range] = "range",
  [sym_open_range] = "open_range",
  [sym_time] = "time",
  [aux_sym__summary_line] = "_summary_line",
  [sym_tag] = "tag",
  [aux_sym_source_file_repeat1] = "source_file_repeat1",
  [aux_sym_record_repeat1] = "record_repeat1",
  [aux_sym_record_summary_repeat1] = "record_summary_repeat1",
  [aux_sym_entry_summary_repeat1] = "entry_summary_repeat1",
};
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym__entry_break] = sym__entry_break,
  [sym__continuation_break] = sym__continuation_break,
  [sym__record_separator] = sym__record_separator,
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [sym__continuation_break] = {
    .visible = false,
    .named = true,
  },
  [sym__record_separator] = {
    .visible = false,
    .named = true,
  },
  [sym__error_sentinel] = {
...
static const char * const ts_field_names[] = {
  ...
  [field_entry] = "entry",
  [field_name] = "name",
  [field_should_total] = "should_total",
  [field_start] = "start",
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_tag_value_character_set_1, 682, lookahead)) ADVANCE(84);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
    ...
    case 30:
      ...
      if (set_contains(sym_tag_value_character_set_1, 682, lookahead)) ADVANCE(95);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          lookahead != '\r') ADVANCE(73);
    ...
    case 34:
      ...
      if (lookahead == '\t' ||
          lookahead == ' ') SKIP(35);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(81);
      if (set_contains(sym_tag_name_character_set_1, 680, lookahead)) ADVANCE(84);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          lookahead != '\r') ADVANCE(73);
    ...
    case 86:
      ...
      if (set_contains(sym_tag_name_character_set_1, 680, lookahead)) ADVANCE(95);
      END_STATE();
    case 87:
      ACCEPT_TOKEN(sym_tag_value);
...
static const TSLexerMode ts_lex_modes[STATE_COUNT] = {
  ...
  [3] = {.lex_state = 35, .external_lex_state = 4},
  [4] = {.lex_state = 35, .external_lex_state = 3},
  [5] = {.lex_state = 35, .external_lex_state = 4},
  [6] = {.lex_state = 35, .external_lex_state = 4},
  ...
  [11] = {.lex_state = 29, .external_lex_state = 4},
  ...
  [28] = {.lex_state = 35, .external_lex_state = 4},
  [29] = {.lex_state = 35, .external_lex_state = 5},
  [30] = {.lex_state = 35, .external_lex_state = 5},
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [STATE(0)] = {
    ...
    [sym__entry_break] = ACTIONS(1),
    [sym__continuation_break] = ACTIONS(1),
    [sym__record_separator] = ACTIONS(1),
  ...
  [STATE(1)] = {
    ...
    [sym_date] = ACTIONS(5),
    [sym__record_separator] = ACTIONS(7),
  },
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [9] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry, 1, 0, 5),
  [11] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [13] = {.entry = {.count = 1, .reusable = false}}, SHIFT(4),
  [15] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_summary, 1, 0, 0),
  [19] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [21] = {.entry = {.count = 1, .reusable = false}}, SHIFT(6),
  [23] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry_summary, 1, 0, 0),
  [27] = {.entry = {.count = 1, .reusable = false}}, SHIFT(8),
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_summary_repeat1, 2, 0, 0),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__summary_line, 2, 0, 0),
  [33] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__summary_line, 2, 0, 0), SHIFT_REPEAT(10),
  [36] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__summary_line, 2, 0, 0), SHIFT_REPEAT(6),
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entry_summary_repeat1, 2, 0, 0),
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__summary_line, 2, 0, 0), SHIFT_REPEAT(13),
  [44] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__summary_line, 2, 0, 0), SHIFT_REPEAT(8),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 3, 0, 9),
  [49] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tag, 3, 0, 9),
  [51] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__summary_line, 1, 0, 0),
  [55] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__summary_line, 1, 0, 0),
  [57] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 1, 0, 1),
  [61] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [63] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [65] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 2, 0, 9),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tag, 2, 0, 9),
  [71] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [73] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 1, 0, 0),
  [77] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [79] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_time, 1, 0, 0),
  [81] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [83] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_open_range, 3, 0, 13),
  [87] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_open_range, 3, 0, 13),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 4, 0, 16),
  [91] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tag, 4, 0, 16),
  [93] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [95] = {.entry = {.count = 1, .reusable = true}}, SHIFT(49),
  [97] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range, 3, 0, 13),
  [101] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range, 3, 0, 13),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 2, 0, 0),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_time, 2, 0, 0),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 2, 0, 2),
  [109] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_summary, 2, 0, 0),
  [113] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_entry_summary_repeat1, 2, 0, 0), SHIFT_REPEAT(42),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry_summary, 2, 0, 0),
  [118] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_summary_repeat1, 2, 0, 0), SHIFT_REPEAT(43),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 3, 0, 7),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 4, 0, 10),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 8),
  [127] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 8), SHIFT_REPEAT(19),
  [130] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 4, 0, 12),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 3, 0, 4),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0),
  [138] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(11),
  [141] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(35),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 2, 0, 3),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 5, 0, 15),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_should_total, 4, 0, 14),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry, 2, 0, 11),
  ...
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 6),
...
enum ts_external_scanner_symbol_identifiers {
  ...
  ts_external_token__entry_break = 1,
  ts_external_token__continuation_break = 2,
  ts_external_token__record_separator = 3,
  ts_external_token__error_sentinel = 4,
};

static const TSSymbol ts_external_scanner_symbol_map[EXTERNAL_TOKEN_COUNT] = {
  [ts_external_token__line_break] = sym__line_break,
  [ts_external_token__entry_break] = sym__entry_break,
  [ts_external_token__continuation_break] = sym__continuation_break,
  [ts_external_token__record_separator] = sym__record_separator,
...
static const bool ts_external_scanner_states[6][EXTERNAL_TOKEN_COUNT] = {
  [1] = {
    ...
    [ts_external_token__entry_break] = true,
    [ts_external_token__continuation_break] = true,
    [ts_external_token__record_separator] = true,
